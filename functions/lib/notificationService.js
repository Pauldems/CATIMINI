...
exports.onNotificationCreated = exports.testNotification = void 0;
...
exports.testNotification = (0, https_1.onCall)({ cors: true }, async (request) => {
    try {
        ...
        const { userId, title, message, testMode } = request.data;
        ...
        await sendExpoPushNotification(pushToken, testTitle, testMessage, {
            test: true,
            userId: targetUserId,
...
exports.onNotificationCreated = (0, firestore_1.onDocumentCreated)('notifications/{notificationId}', async (event) => {
    ...
    try {
        ...
        // Envoyer la notification push
        await sendExpoPushNotification(pushToken, notificationData.title, notificationData.message, pushData);
